...
public class ChatClientConfig {
    ...
    @Bean("openaiCCNoMem")
    public ChatClient openaiCCNoMem(OpenAiChatModel openAiChatModel) {
    ...
    public ChatClient openaiCCNoMemRedisCache(OpenAiChatModel openAiChatModel, @Qualifier("redisSemanticCacheAdvisor") SemanticCacheAdvisor redisSemanticCacheAdvisor) {
    ...
    public ChatClient openaiCCNoMemVectorStoreCache(OpenAiChatModel openAiChatModel, @Qualifier("qdrantSemanticCacheAdvisor") SemanticCacheAdvisor vectorStoreSemanticCacheAdvisor) {
    ...
    public ChatClient openaiCCInMemory(OpenAiChatModel openAiChatModel, @Qualifier("inMemoryChatMemory") ChatMemory chatMemory) {
    ...
    public ChatClient openaiCCJdbcMemory(OpenAiChatModel openAiChatModel, @Qualifier("jdbcChatMemory") ChatMemory chatMemory) {
    ...
    public ChatClient ollamaCCJdbcMemory(OllamaChatModel ollamaChatModel, @Qualifier("jdbcChatMemory") ChatMemory chatMemory) {
    ...
    public ChatClient openaiCCJdbcMemoryWithToolCalling(OpenAiChatModel openAiChatModel, @Qualifier("jdbcChatMemory") ChatMemory chatMemory, TimeTool timeTool) {
